...
The rest of the time we tried to get the API to work with JavaScript (Node). Here we already pretty much hit a wall, knowing that the API is really bad and outdated.
